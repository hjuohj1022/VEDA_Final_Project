param(
    ...
    [string]$Da3MetricTargetDir = "fact/checkpoints/DA3METRIC-LARGE",
...
$localPathsFile = Join-Path $ProjectRoot "local_paths.cmake"
...
Write-Host "2) Verify app_config.h ENGINE_PATH exists on this PC"
Write-Host "3) (Optional) Export ONNX from DA3 Metric: python fact/export_da3metric_onnx.py --height 490 --width 868"
