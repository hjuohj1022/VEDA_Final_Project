...
class ClientGui(tk.Tk):
    def __init__(self) -> None:
        ...
        self.ca_file_var = tk.StringVar(value="certs/forTestClient/rootCA.crt")
        self.client_cert_var = tk.StringVar(value="certs/forTestClient/cctv.crt")
        self.client_key_var = tk.StringVar(value="certs/forTestClient/cctv.key")
