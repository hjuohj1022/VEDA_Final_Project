...
class ClientGui(tk.Tk):
    def __init__(self) -> None:
        ...
        self.ca_file_var = tk.StringVar(value="certs/mTLS/rootCA.crt")
        self.client_cert_var = tk.StringVar(value="certs/mTLS/server.crt")
        self.client_key_var = tk.StringVar(value="certs/mTLS/server.key")
