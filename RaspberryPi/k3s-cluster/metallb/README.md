...
- 현재 주소 풀: `192.168.55.200-192.168.55.210`
...
- **기능 1:** `192.168.55.200-192.168.55.210` 범위에서 외부 IP를 할당합니다.
...
- 주소 범위: `192.168.55.200-192.168.55.210`
